...
export const Icons = {
  ...
  /** Quill icon (writing) */
  Quill: () => <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>,
  /** Sparkles icon (magic/AI) */
  ...
  /** Gemini icon (Google AI logo) */
  Gemini: () => (
    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2C10.5 8 8 10.5 2 12C8 13.5 10.5 16 12 22C13.5 16 16 13.5 22 12C16 10.5 13.5 8 12 2Z" />
      <path d="M12 6C11.25 9 10 10.25 7 11C10 11.75 11.25 13 12 16C12.75 13 14 11.75 17 11C14 10.25 12.75 9 12 6Z" fillOpacity="0.5" />
    </svg>
  ),
  ...
  Microphone: () => <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3l18 18" /></svg>,
  /** Stop circle icon (stop recording) */
  StopCircle: () => <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8 7a1 1 0 00-1 1v4a1 1 0 001 1h4a1 1 0 001-1V8a1 1 0 00-1-1H8z" clipRule="evenodd" /></svg>,
  /** File text icon (document) */
  FileText: () => <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>,
  /** Image icon (picture) */
  ...
  /** Music note icon (audio) */
  MusicNote: () => <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" /></svg>,
  /** Settings icon (gear) */
  ...
  /** Aalok Icon (Flame/Light) - Represents enlightenment and knowledge */
  Aalok: () => (
    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2C11 8 8 10.5 5 12C8 13.5 11 16 12 22C13 16 16 13.5 19 12C16 10.5 13 8 12 2Z" />
      <path d="M12 6C11.5 9 10 10.25 8.5 11C10 11.75 11.5 13 12 16C12.5 13 14 11.75 15.5 11C14 10.25 12.5 9 12 6Z" fillOpacity="0.5" />
    </svg>
  )
};
